## Hi there 👋 I'm yo-works91

### 🚀 About Me
Backend Engineerとして、スケーラブルなシステム設計と開発に情熱を注いでいます。  
FullStack開発からプロジェクトマネジメントまで幅広い経験を持ち、技術的な課題解決とチーム成長に貢献することを大切にしています。

現在は新しい技術スタックの習得と、より効率的な開発プロセスの構築に取り組んでいます。
...
- 🌱 Rust、Goを使った高性能バックエンド開発
- 📚 クラウドネイティブ技術の深掘り
- 🤝 チーム開発効率化のためのDevOps実践
